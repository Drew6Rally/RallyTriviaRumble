...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.question = await PlayerQuestionSubsTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'trivia_host',
              true.toString(),
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<PlayerQuestionSubsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PlayerQuestionSubsRow> homePlayerQuestionSubsRowList =
            snapshot.data!;
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: FutureBuilder<
                                        List<PlayerQuestionSubsRow>>(
                                      future:
                                          PlayerQuestionSubsTable().queryRows(
                                        queryFn: (q) => q,
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewPlayerQuestionSubsRow =
                                                listViewPlayerQuestionSubsRowList[
                                                    listViewIndex];
                                            return Padding(
                                              padding: EdgeInsetsDirectional
